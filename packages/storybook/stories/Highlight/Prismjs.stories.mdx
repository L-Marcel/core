...
It is possible, but quite complex, to edit language definitions using the library, but this is only available for the [available languages](https://core-l-marcel.vercel.app/?path=/story/highlight-available-languages--page) (it inevitably requires extensive knowledge of regex):
<Highlight
